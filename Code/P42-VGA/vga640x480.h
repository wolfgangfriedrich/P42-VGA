...
#define STARTLINE (FRONT_PORCH_LINES+2)
#define YPIXELS 480
/// The last picture area line
#define ENDLINE STARTLINE+YPIXELS+33
...
#define HSYNC_WIDTH_XTALCLKS 38//14
...
#define OP1 (unsigned long)(PICK_Y + PICK_BITS(3) + SHIFT_BITS(3))
...
//#define OP3 (unsigned long)(PICK_A + PICK_BITS(4) + SHIFT_BITS(2))
...
#define BURST_LEVEL 0x9980 // burst level should be at least 38 IRE, is here only 32 IRE
